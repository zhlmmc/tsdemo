...
describe('MathUtils', () => {
  ...
  describe('average', () => {
    ...
    it('should calculate average of positive numbers correctly', () => {
  ...
  describe('findMax', () => {
    ...
    it('should find maximum in mixed positive and negative numbers', () => {
      expect(MathUtils.findMax([-1, -5, 0, -2])).toBe(0);
    });
  ...
  describe('findMin', () => {
    ...
    it('should find minimum in mixed positive and negative numbers', () => {
      expect(MathUtils.findMin([-1, -5, 0, -2])).toBe(-5);
    });
